        ...
        {isEditing ? (
          <form onSubmit={handleSubmit} className="space-y-4 text-xs font-sans">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Company Name *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Job Role *</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Industry</label>
                <input
                  type="text"
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Employment Type</label>
                <select
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Joining Date *</label>
                <input
                  type="date"
                  required
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Work Location</label>
                <input
                  type="text"
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Training Relevance</label>
                <select
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Job Satisfaction (1-5)</label>
                <input
                  type="number"
                  min={1}
                  max={5}
            ...
            <div>
              <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Skills Used (comma-separated)</label>
              <input
                type="text"
            ...
            <Button type="submit" variant="primary" isLoading={isUpdating} className="font-bold text-xs uppercase gap-1.5">
              <Save className="h-4 w-4 text-black" /> Save Employment Details
            </Button>
          </form>
        ) : (
          <div className="space-y-4 text-xs font-sans">
            {!employmentDetails?.companyName ? (
              <div className="p-4 text-center text-muted-foreground bg-surface-secondary rounded-sm border border-dashed border-border space-y-2">
                <p className="font-bold text-card-foreground text-base uppercase">Complete your employment information</p>
                <p className="text-xs">Click "Edit Details" to record your company, job role, and location.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div className="p-3.5 rounded-sm bg-surface-secondary border border-border space-y-1">
                  <div className="text-muted-foreground font-mono font-bold flex items-center gap-1.5 text-[11px] uppercase">
                    <Building className="h-3.5 w-3.5 text-[#FFD400]" /> Company
                  </div>
                  <div className="font-bold text-lg text-card-foreground uppercase">
                    {employmentDetails.companyName}
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-sm bg-surface-secondary border border-border space-y-1">
                  <div className="text-muted-foreground font-mono font-bold text-[11px] uppercase">Employment Type</div>
                ...
                <div className="p-3.5 rounded-sm bg-surface-secondary border border-border space-y-1">
                  ...
                  <div className="font-mono font-bold text-sm text-card-foreground">
