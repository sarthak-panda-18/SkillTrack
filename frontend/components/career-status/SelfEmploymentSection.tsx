        ...
        {isEditing ? (
          <form onSubmit={handleSubmit} className="space-y-4 text-xs font-sans">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Business Name *</label>
                <input
                  type="text"
                  required
                  value={businessName}
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Business Type</label>
                <input
                  type="text"
                  value={businessType}
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Business Status</label>
                <select
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Current Annual Income (₹)</label>
                <input
                  type="number"
                  value={currentIncome}
              ...
              <div>
                <label className="font-mono font-bold text-muted-foreground uppercase block mb-1">Number of Employees</label>
                <input
                  type="number"
            ...
            <Button type="submit" variant="primary" isLoading={isUpdating} className="font-bold text-xs uppercase gap-1.5">
              <Save className="h-4 w-4 text-black" /> Save Self-Employment Details
            </Button>
          </form>
        ) : (
          <div className="space-y-4 text-xs font-sans">
            {!selfEmploymentDetails?.businessName ? (
              <div className="p-4 text-center text-muted-foreground bg-surface-secondary rounded-sm border border-dashed border-border space-y-2">
                <p className="font-bold text-card-foreground text-base uppercase">Provide business details</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="p-4 rounded-sm bg-surface-secondary border border-border space-y-1">
                  <span className="text-muted-foreground font-mono font-bold text-[11px] block uppercase">Business Status</span>
                ...
                <div className="p-4 rounded-sm bg-surface-secondary border border-border space-y-1">
                  <span className="text-muted-foreground font-mono font-bold text-[11px] block uppercase">Annual Income</span>
