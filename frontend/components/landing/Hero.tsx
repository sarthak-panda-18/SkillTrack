...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-16 pb-20 sm:pt-24 sm:pb-32 border-b border-border bg-background text-foreground transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <Badge variant="default" className="px-3.5 py-1 text-xs font-mono font-bold uppercase tracking-widest rounded-sm bg-[#FFD400]/10 text-yellow-900 dark:text-[#FFD400] border border-[#FFD400]/40">
        ...
        <motion.div
          ...
          className="mt-14 max-w-5xl mx-auto rounded-sm border border-border bg-card p-4 sm:p-6 shadow-2xl text-left"
        >
          {/* Header Bar */}
          <div className="flex items-center justify-between border-b border-border pb-4 mb-6">
            <div className="flex items-center gap-2">
              <div className="h-3 w-3 rounded-full bg-[#FFD400]/40" />
              <div className="h-3 w-3 rounded-full bg-border" />
              <div className="h-3 w-3 rounded-full bg-border" />
              <span className="font-mono text-xs font-bold text-muted-foreground ml-2">SKILLTRACK_AI // CONSOLE_v1.0</span>
            </div>
            <Badge variant="default" className="text-[10px] font-mono font-bold bg-[#FFD400]/10 text-yellow-900 dark:text-[#FFD400] border border-[#FFD400]/30">LIVE CONSOLE PREVIEW</Badge>
          </div>

          {/* Console Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-sm bg-surface-secondary border border-border hover:border-[#FFD400]/30 transition-colors">
              ...
              <div className="mt-3 space-y-1.5">
                ...
                <div className="h-2 rounded-sm bg-surface border border-border overflow-hidden">
            ...
            <div className="p-4 rounded-sm bg-surface-secondary border border-border hover:border-[#FFD400]/30 transition-colors">
              ...
              <div className="flex flex-wrap gap-1.5 mt-3">
                <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-sm bg-[#FFD400]/15 text-foreground border border-[#FFD400]/40">SYSTEM DESIGN</span>
                <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-sm bg-[#FFD400]/15 text-foreground border border-[#FFD400]/40">DOCKER</span>
                <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-sm bg-[#FFD400]/15 text-foreground border border-[#FFD400]/40">POSTGRESQL</span>
              </div>
            </div>
